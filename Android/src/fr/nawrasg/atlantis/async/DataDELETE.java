...
public class DataDELETE extends AsyncTask<String, Void, String> {
	...
	public DataDELETE(Context context) {
		mContext = context;
	...
	public DataDELETE(Context context, boolean progressbar) {
		mContext = context;
		mShowPB = progressbar;
		mPD = new ProgressDialog(mContext);
		mPD.setCancelable(true);
	...
	protected String doInBackground(String... x) {
		...
		try {
			...
			nConnection.setRequestMethod("DELETE");
