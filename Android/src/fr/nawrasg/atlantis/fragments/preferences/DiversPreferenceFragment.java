...
public class DiversPreferenceFragment extends PreferenceFragment implements OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (mPM.isIgnoringBatteryOptimizations(mContext.getPackageName())) {
                mDozePreference.setChecked(true);
            } else {
                mDozePreference.setChecked(false);
            }
            mDozePreference.setOnPreferenceChangeListener(this);
        } else {
            mDozePreference.setEnabled(false);
        }
    }
    ...
    private void ignoreDoze() {
        ...
        nIntent.setAction(Settings.ACTION_IGNORE_BATTERY_OPTIMIZATION_SETTINGS);
